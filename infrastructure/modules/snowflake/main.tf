...
# as outputs so the root module can connrct the IAM role trust policy.
...
# STORAGE INTEGRATION is used to Secure trust between Snowflake and your S3 data lake.
...
# Both are exposed as outputs for the root module trust connect.
